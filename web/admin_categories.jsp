...
<html lang="en">
   ...
   <body onload="time()" class="app sidebar-mini rtl">
                    ...
                    <div class="tile-body">
                        ...
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <c:forEach items="${LIST_CATEGORIES}" var="c">
                                ...
                                <!-- MODAL for Edit -->
                                <div class="modal fade" id="ModalUP${c.id}" tabindex="-1" aria-labelledby="editCategoryLabel${c.id}" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                                ...
                                                <form action="EditCategoryServlet" method="GET">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <label class="control-label" for="category_id">Mã danh mục</label>
                                                            <input class="form-control" type="text" readonly name="category_id" value="${c.id}">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label class="control-label" for="category_name">Tên</label>
                                                            <input class="form-control" type="text" name="category_name" value="${c.name}">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label for="type_id" class="control-label">Danh mục</label>
    ...
    <div class="modal fade" id="modal_box" role="dialog" aria-labelledby="deleteConfirmationLabel" aria-hidden="true"></div>
    ...
    <script type="text/javascript">
        function confirmDelete(modalID, cid) {
            ...
            let modal = '<div class="modal-dialog modal-dialog-centered" role="dialog" aria-labelledby="deleteConfirmationLabel" style="text-align:center">' +
