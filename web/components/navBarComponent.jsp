...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="home">Furniture world</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <c:if test ="${sessionScope.acc.isAdmin ==1 || sessionScope.acc.isSell ==1}">
                ...
                <c:if test="${sessionScope.acc != null}">
                    <li class="nav-item">
                         <a class="nav-link active" aria-current="page" href="ProfileServlet?id=${sessionScope.acc.uid}">Hello ${sessionScope.acc.user}</a>
                    </li>
                </c:if>
